...
public class Registerer {
	...
	{
		biome.setRegistryName(new ResourceLocation(Reference.MOD_ID, biome.getBiomeName()));
		ForgeRegistries.BIOMES.register(biome);
	}

	public static void register(Class<? extends Entity> entity, String name, int id)
	{
		EntityRegistry.registerModEntity(entity, name, id, Floricraft.instance, 80, 3, true);
	}
